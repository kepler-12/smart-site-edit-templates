...
function readQueryFromStore(options) {
    ...
    return diffQueryAgainstStore(__assign$3({}, options, optsPatch)).result;
}
...
function addPreviousResultToIdValues(value, previousResult) {
    if (apolloUtilities.isIdValue(value)) {
        return __assign$3({}, value, { previousResult: previousResult });
    }
    else if (Array.isArray(value)) {
...
var RecordingCache = (function () {
    ...
    RecordingCache.prototype.toObject = function () {
        return __assign$4({}, this.data, this.recordedData);
    };
    ...
    RecordingCache.prototype.replace = function (newData) {
        this.clear();
        this.recordedData = __assign$4({}, newData);
    };
